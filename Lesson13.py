...
if b >= a:
    ...
    for i in range(b, a+1):
        ...
        count += 1
tbc = sum / count 
tbc = round(tbc, 2)     # làm tròn đến chữ số thập phân thứ 2
print('Trung bình cộng các số trong khoảng trên:', tbc)
...
arr1 = a.split()                # split(): hàm tách chuỗi học ở lesson11
